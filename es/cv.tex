...
\begin{itemize}[leftmargin=0.7cm, label=\faIcon{briefcase}]
    ...
    Desarrollo y despliegue de un sitio web de comercio electrónico completo usando React y Vite. Implementación de catálogo de productos responsivo con múltiples categorías y filtrado . Gestión de estado global con Context API y despliegue en Cloudflare Pages. \\
    Sitio: \href{https://linea-y-forma.com}{linea-y-forma.com}
\end{itemize}

\cvsection{Educación}
\begin{itemize}[leftmargin=0.7cm, label=\faIcon{graduation-cap}]
    \item \textbf{Ingeniería de Sistemas} \\
    Universidad Tecnológica del Perú (2024 -- Presente) \\
