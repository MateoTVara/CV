...
%--------------------
{\color{blue}\fontsize{14.5}{18}\bfseries\selectfont Resumen Profesional} \hfill \rule{0.70\linewidth}{1.2pt}
...
conocimientos prácticos en sistemas Linux, particularmente en entornos Arch
%  y basados en Nix
. Habilidad
...
% \spaced{9.5}{D}\spaced{7.5}{ISEÑADOR}/%
\spaced{9.5}{D}\spaced{7.5}{ESARROLLADOR} \hfill {\fontsize{8}{10}\extralight\selectfont Jul. 2025 - Actualidad}
...
\textbf{\fontsize{11}{14}\selectfont Lenguajes} & {\fontsize{10}{12}\extralight\selectfont {\fontsize{10}{12}\extralight\selectfont\textbf{JavaScript/TypeScript}}, Python} \\
...
\textbf{\fontsize{11}{14}\selectfont DevOps} & {\fontsize{10}{12}\extralight\selectfont \textbf{Linux}, \textbf{Nix}, Bash, GitHub Actions} \\
\textbf{\fontsize{11}{14}\selectfont Programas} & {\fontsize{10}{12}\extralight\selectfont \textbf{Git}, \textbf{PostgreSQL}, \textbf{SQLite}} \\
\end{tabularx}
}
